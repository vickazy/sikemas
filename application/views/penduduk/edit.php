                ...
                <div class="block">
                    ...
                    <form action="<?php echo site_url('Penduduk/edit_proses/'.$penduduk['nik']) ?>" method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="example-datepicker3" type="text" name="tanggal_lahir" class="form-control input-datepicker"  placeholder="Tanggal/Bulan/Tahun" data-date-format="dd-mm-yyyy" value="<?php echo $penduduk['tanggal_lahir'] ?>">
